                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('journals.show', $journal) }}" class="btn btn-info">👁️</a>
                                <a href="{{ route('journals.export-pdf', $journal) }}" class="btn btn-danger">📄</a>
                                <a href="{{ route('journals.edit', $journal) }}" class="btn btn-warning">✏️</a>
