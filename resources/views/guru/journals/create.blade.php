...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 style="color: #f8fafc;">📝 Form Jurnal Mengajar Harian</h1>
        ...
        <form action="{{ route('guru.journals.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="material" class="form-control @error('material') is-invalid @enderror"
                    rows="2" required
                    style="background:rgba(0,0,0,0.3);border:1px solid rgba(255,255,255,0.1);color:white;border-radius:10px;">{{ old('material') }}</textarea>
                @error('material')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="learning_activity" class="form-control @error('learning_activity') is-invalid @enderror"
                    rows="3" required
                    style="background:rgba(0,0,0,0.3);border:1px solid rgba(255,255,255,0.1);color:white;border-radius:10px;">{{ old('learning_activity') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="notes" class="form-control" rows="2"
                    style="background:rgba(0,0,0,0.3);border:1px solid rgba(255,255,255,0.1);color:white;border-radius:10px;">{{ old('notes') }}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="catatan_kepsek" class="form-control" rows="3"
                    style="background:rgba(0,0,0,0.3);border:1px solid rgba(255,255,255,0.1);color:white;border-radius:10px;"
                    placeholder="Tulis catatan dari Kepala Sekolah (opsional)">{{ old('catatan_kepsek') }}</textarea>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label text-white">Foto 1</label>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label text-white">Foto 2</label>
