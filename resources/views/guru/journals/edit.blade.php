    ...
    <form action="{{ route('guru.journals.update', $journal) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea name="material" class="form-control @error('material') is-invalid @enderror" 
                      rows="2" required>{{ old('material', $journal->material) }}</textarea>
            @error('material')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="learning_activity" class="form-control @error('learning_activity') is-invalid @enderror" 
                      rows="3" required>{{ old('learning_activity', $journal->learning_activity) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="notes" class="form-control" rows="2">{{ old('notes', $journal->notes) }}</textarea>
        </div>
        ...
        @if($journal->photo1)
            <div class="mb-2">
                <p>Foto 1 saat ini:</p>
                <img src="{{ asset('storage/'.$journal->photo1) }}" style="max-height: 100px;">
            </div>
        @endif
        ...
        @if($journal->photo2)
            <div class="mb-2">
                <p>Foto 2 saat ini:</p>
                <img src="{{ asset('storage/'.$journal->photo2) }}" style="max-height: 100px;">
            </div>
        @endif
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    <label class="form-label">Ganti Foto 1</label>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label class="form-label">Ganti Foto 2</label>
